...
// TestNewOutputParser tests the constructor function
func TestNewOutputParser(t *testing.T) {
	t.Run("CreateNewOutputParser", func(t *testing.T) {
		lm := NewOutputParser(
			func(playerName string) ([]byte, error) { return nil, nil },
			func(playerName string, inventory []byte) error { return nil },
		)
...
// TestOutputParser_Start tests the unified Start method
func TestOutputParser_Start(t *testing.T) {
...
// TestOutputParser_monitorServerLogs tests the log monitoring functionality
func TestOutputParser_monitorServerLogs(t *testing.T) {
...
// TestOutputParser_Integration tests integration scenarios
...
// TestOutputParser_EdgeCases tests edge cases and error conditions
